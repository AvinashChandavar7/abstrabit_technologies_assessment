...
const InterestUptoCard: React.FC<InterestUptoCardProps> = ({
  ...
  return (
    <div className="w-[398px] h-[202px] shadow-sm shadow-[0px 5px 10px #0000000D] border-white border-4 px-2  flex flex-col justify-center gap-4" style={{ backgroundColor: bgColor }}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="font-bold text-sm">{interestRate}% p.a</h1>
        </div>
